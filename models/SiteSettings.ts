...
const SiteSettingsSchema = new Schema(
  {
    ...
    baleUrl: { type: String, trim: true, maxlength: 300 },
    mapUrl: { type: String, trim: true, maxlength: 500 },
    mapEmbedUrl: { type: String, trim: true, maxlength: 1000 },
    baladUrl: { type: String, trim: true, maxlength: 500 },
    neshanUrl: { type: String, trim: true, maxlength: 500 },
    catalogPdfUrl: { type: String, trim: true, maxlength: 500 },
